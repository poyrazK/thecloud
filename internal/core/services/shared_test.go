...
func (m *MockAutoScalingRepo) CreateGroup(ctx context.Context, g *domain.ScalingGroup) error {
...
func (m *MockAutoScalingRepo) UpdateGroup(ctx context.Context, g *domain.ScalingGroup) error {
	return m.Called(ctx, g).Error(0)
}
...
func (m *MockAutoScalingRepo) CreatePolicy(ctx context.Context, p *domain.ScalingPolicy) error {
...
func (m *MockAutoScalingRepo) UpdatePolicyLastScaled(ctx context.Context, id uuid.UUID, lastScaled time.Time) error {
	return m.Called(ctx, id, lastScaled).Error(0)
}

// MockInstanceService
type MockInstanceService struct{ mock.Mock }

func (m *MockInstanceService) LaunchInstance(ctx context.Context, p ports.LaunchParams) (*domain.Instance, error) {
	args := m.Called(ctx, p)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *MockInstanceService) LaunchInstanceWithOptions(ctx context.Context, o ports.CreateInstanceOptions) (*domain.Instance, error) {
	args := m.Called(ctx, o)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *MockInstanceService) UpdateInstanceMetadata(ctx context.Context, id uuid.UUID, meta, labels map[string]string) error {
	return m.Called(ctx, id, meta, labels).Error(0)
}
...
func (m *MockEventService) RecordEvent(ctx context.Context, action, resourceID, resourceType string, metadata map[string]interface{}) error {
	return m.Called(ctx, action, resourceID, resourceType, metadata).Error(0)
}
...
func (m *MockClusterRepo) Create(ctx context.Context, c *domain.Cluster) error {
...
func (m *MockClusterProvisioner) Provision(ctx context.Context, c *domain.Cluster) error {
	return m.Called(ctx, c).Error(0)
}
func (m *MockClusterProvisioner) Deprovision(ctx context.Context, c *domain.Cluster) error {
	return m.Called(ctx, c).Error(0)
}
func (m *MockClusterProvisioner) GetKubeconfig(ctx context.Context, c *domain.Cluster, role string) (string, error) {
	args := m.Called(ctx, c, role)
	return args.String(0), args.Error(1)
}
func (m *MockClusterProvisioner) Repair(ctx context.Context, c *domain.Cluster) error {
	return m.Called(ctx, c).Error(0)
}
func (m *MockClusterProvisioner) Scale(ctx context.Context, c *domain.Cluster) error {
	return m.Called(ctx, c).Error(0)
}
func (m *MockClusterProvisioner) GetHealth(ctx context.Context, c *domain.Cluster) (*ports.ClusterHealth, error) {
	args := m.Called(ctx, c)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *MockClusterProvisioner) Upgrade(ctx context.Context, c *domain.Cluster, version string) error {
	return m.Called(ctx, c, version).Error(0)
}
func (m *MockClusterProvisioner) RotateSecrets(ctx context.Context, c *domain.Cluster) error {
	return m.Called(ctx, c).Error(0)
}
func (m *MockClusterProvisioner) CreateBackup(ctx context.Context, c *domain.Cluster) error {
	return m.Called(ctx, c).Error(0)
}
func (m *MockClusterProvisioner) Restore(ctx context.Context, c *domain.Cluster, backupPath string) error {
	return m.Called(ctx, c, backupPath).Error(0)
}
func (m *MockClusterProvisioner) GetStatus(ctx context.Context, c *domain.Cluster) (domain.ClusterStatus, error) {
	args := m.Called(ctx, c)
...
func (m *MockVpcService) CreateVPC(ctx context.Context, name, cidr string) (*domain.VPC, error) {
...
func (m *MockSecretService) CreateSecret(ctx context.Context, name, value, desc string) (*domain.Secret, error) {
	args := m.Called(ctx, name, value, desc)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *MockLBService) Create(ctx context.Context, name string, vpcID uuid.UUID, port int, algo, key string) (*domain.LoadBalancer, error) {
	args := m.Called(ctx, name, vpcID, port, algo, key)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
	return args.Get(0).(*domain.LoadBalancer), args.Error(1)
}
func (m *MockLBService) Get(ctx context.Context, id string) (*domain.LoadBalancer, error) {
	args := m.Called(ctx, id)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *MockLBService) Delete(ctx context.Context, id string) error {
	return m.Called(ctx, id).Error(0)
}
...
func (m *MockFileStore) Write(ctx context.Context, bucket string, key string, r io.Reader) (int64, error) {
	args := m.Called(ctx, bucket, key, r)
	return args.Get(0).(int64), args.Error(1)
}
func (m *MockFileStore) Read(ctx context.Context, bucket string, key string) (io.ReadCloser, error) {
...
func (m *MockFileStore) Delete(ctx context.Context, bucket string, key string) error {
...
func (m *MockVolumeService) AttachVolume(ctx context.Context, volumeID, instanceID, mountPath string) (string, error) {
...
// MockSnapshotService
type MockSnapshotService struct{ mock.Mock }

func (m *MockSnapshotService) CreateSnapshot(ctx context.Context, volumeID uuid.UUID, desc string) (*domain.Snapshot, error) {
	args := m.Called(ctx, volumeID, desc)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *MockSnapshotService) RestoreSnapshot(ctx context.Context, id uuid.UUID, name string) (*domain.Volume, error) {
...
// MockVolumeRepo
type MockVolumeRepo struct{ mock.Mock }
...
func (m *MockEventRepo) ListByTenantID(ctx context.Context, tenantID uuid.UUID, limit int) ([]*domain.Event, error) {
...
func (m *MockComputeBackend) DeleteInstance(ctx context.Context, containerID string) error {
	return m.Called(ctx, containerID).Error(0)
}
func (m *MockComputeBackend) StartInstance(ctx context.Context, containerID string) error {
	return m.Called(ctx, containerID).Error(0)
}
func (m *MockComputeBackend) StopInstance(ctx context.Context, containerID string) error {
	return m.Called(ctx, containerID).Error(0)
}
func (m *MockComputeBackend) GetInstanceLogs(ctx context.Context, containerID string) (io.ReadCloser, error) {
...
func (m *MockComputeBackend) GetInstanceStats(ctx context.Context, containerID string) (io.ReadCloser, error) {
	args := m.Called(ctx, containerID)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *MockComputeBackend) AttachVolume(ctx context.Context, containerID, path string) (string, error) {
...
func (m *MockComputeBackend) GetInstanceIP(ctx context.Context, containerID string) (string, error) {
	args := m.Called(ctx, containerID)
	return args.String(0), args.Error(1)
}
...
func (m *MockIdentityService) RevokeKey(ctx context.Context, userID, keyID uuid.UUID) error {
	return m.Called(ctx, userID, keyID).Error(0)
}
func (m *MockIdentityService) RotateKey(ctx context.Context, userID, keyID uuid.UUID) (*domain.APIKey, error) {
...
func (m *MockLogRepository) Create(ctx context.Context, logs []*domain.LogEntry) error {
...
func (m *MockQueueRepo) Create(ctx context.Context, queue *domain.Queue) error {
...
func (m *MockDatabaseRepo) GetByName(ctx context.Context, userID uuid.UUID, name string) (*domain.Database, error) {
	args := m.Called(ctx, userID, name)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *MockDatabaseRepo) ListAll(ctx context.Context) ([]*domain.Database, error) {
	args := m.Called(ctx)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
type MockLifecycleRepository struct{ mock.Mock }
...
type MockSnapshotRepository = MockSnapshotRepo
